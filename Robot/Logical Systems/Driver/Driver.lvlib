...
<Library LVVersion="13008000">
	...
	<Item Name="Messages" Type="Folder">
		<Item Name="New Driver Input Msg.lvclass" Type="LVClass" URL="../Driver-Logical Messages/New Driver Input Msg/New Driver Input Msg.lvclass"/>
		<Item Name="Write Driver Status Ref Msg.lvclass" Type="LVClass" URL="../Driver Messages/Write Driver Status Ref Msg/Write Driver Status Ref Msg.lvclass"/>
	</Item>
	<Item Name="Arcade Mode.vi" Type="VI" URL="../Arcade Mode.vi"/>
	<Item Name="Driver.lvclass" Type="LVClass" URL="../Driver-Logical/Driver.lvclass"/>
</Library>
